namespace Steam_Desktop_Authenticator
{
    partial class PhoneInputForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Для добавления мобильного аутентификатора к вашему аккаунту Steam требуется номер телефона.\r\nЭтот номер должен иметь возможность получать SMS.\r\nVoIP и виртуальные номера не поддерживаются.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Двухбуквенный код страны для номера телефона:";
            // 
            // label3
            // 
            ...
            this.Text = "Ввод номера телефона";
