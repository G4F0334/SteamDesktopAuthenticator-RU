namespace Steam_Desktop_Authenticator
{
    partial class LoginForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelLoginExplanation.Text = "Это активирует Steam Desktop Authenticator на вашем аккаунте Steam. Для этого тре" +
    "буется номер телефона, способный получать SMS.";
            // 
            // LoginForm
            // 
