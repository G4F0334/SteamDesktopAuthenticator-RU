namespace Steam_Desktop_Authenticator
{
    partial class WelcomeForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnImportConfig.Text = "Я уже настраивал Steam Desktop Authenticator в другом месте на этом ПК и хочу импортировать аккаунты.";
            ...
            this.label2.Text = "Выберите действие для начала работы:";
            ...
            this.btnJustStart.Text = "Я запускаю впервые и\nпросто хочу войти в свой Steam-аккаунт(ы).";
